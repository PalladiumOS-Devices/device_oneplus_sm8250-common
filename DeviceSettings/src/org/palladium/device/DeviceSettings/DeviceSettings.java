...
import org.palladium.device.DeviceSettings.FPSInfoService;
import org.palladium.device.DeviceSettings.DolbySwitch;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
          if (preference == mMuteMedia) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.palladium.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
